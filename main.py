...
async def start(bot, m):
    await m.reply_text(f"<b>হ্যালো {m.from_user.mention} 👋\n\nআপনার বট এখন পুরোপুরি রেডি!\n\n✅ ডাবল মেসেজ আসা বন্ধ করা হয়েছে।\n✅ ভিমো ও বানি নেট সাপোর্ট অ্যাড করা হয়েছে।\n✅ লিঙ্ক দিন অথবা /upload দিয়ে ফাইল পাঠান।</b>")
...
async def direct_download(bot, m):
    ...
    try:
        await msg.edit_text("📥 **ডাউনলোড শুরু হয়েছে (360p)...**")
        ...
        if os.path.exists(res_file):
            ...
            await msg.edit_text("❌ ফাইল পাওয়া যায়নি। পাইথন ভার্সন ৩.১০ বা কুকি চেক করুন।")
